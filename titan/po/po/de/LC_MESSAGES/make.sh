#####
#echo "### translation" > source.titan/po/de/LC_MESSAGES/titan.po
...
#iconv -f ISO-8859-1 -t UTF-8 $HOME/flashimg/source.titan/po/de/LC_MESSAGES/titan.po_auto.po > $HOME/flashimg/source.titan/po/de/LC_MESSAGES/titan.po_auto.po.utf

SEARCH=`cat $HOME/flashimg/source.titan/po/de/LC_MESSAGES/titan.po_auto.po | grep -n "MIME-Version: 1.0" | cut -d":" -f1`
CUT=`expr $SEARCH + 1`

cat $HOME/flashimg/source.titan/po/de/LC_MESSAGES/titan.po_auto.po | sed "1,"$CUT"d" > $HOME/flashimg/source.titan/po/de/LC_MESSAGES/titan.po

echo msgfmt -v $HOME/flashimg/source.titan/po/de/LC_MESSAGES/titan.po -o $HOME/flashimg/source.titan/po/de/LC_MESSAGES/titan.mo
msgfmt -v $HOME/flashimg/source.titan/po/de/LC_MESSAGES/titan.po -o $HOME/flashimg/source.titan/po/de/LC_MESSAGES/titan.mo
