...
//		var_screeninfo.bits_per_pixel = fb->colbytes;
	...
	if(frameb1 == 0 && checkchipset("HI3798MV200") == 0 && checkrealbox("HD51") == 0 && checkrealbox("HD60") == 0 && checkrealbox("HD61") == 0 && checkbox("DM7020HD") == 0 && checkbox("DM7020HDV2") == 0 && checkbox("DM900") == 0 && checkbox("DM920") == 0 && checkbox("WETEK") == 0 && checkbox("DM520") == 0 && checkbox("DM525") == 0 )
	{ 
