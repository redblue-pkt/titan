...
#		TITLE=`echo $TITLE | sed 's/&szlig;/\�/g'`
		...
		TITLE=`echo $TITLE | sed 's/&uuml;/ü/g'`
		TITLE=`echo $TITLE | sed 's/&ouml;/ö/g'`
		TITLE=`echo $TITLE | sed 's/&eacute;/é/g'`
		TITLE=`echo $TITLE | sed 's/&egrave;/è/g'`
		TITLE=`echo $TITLE | sed 's/%F6/ö/g'`
		TITLE=`echo $TITLE | sed 's/%FC/ü/g'`
		TITLE=`echo $TITLE | sed 's/%E4/ä/g'`
		TITLE=`echo $TITLE | sed 's/%26/&/g'`
		TITLE=`echo $TITLE | sed 's/%C4/Ä/g'`
		TITLE=`echo $TITLE | sed 's/%D6/Ö/g'`
		TITLE=`echo $TITLE | sed 's/%DC/Ü/g'`
		TITLE=`echo $TITLE | sed 's/|/-/g'`
		TITLE=`echo $TITLE | sed 's/(/ /g'`
		TITLE=`echo $TITLE | sed 's/)/ /g'`
		TITLE=`echo $TITLE | sed 's/+/ /g'`
...
#watchlist="
#A;/ard/servlet/ajax-cache/3474820/view=list/initial=A/index.html
#B;/ard/servlet/ajax-cache/3474820/view=list/initial=B/index.html
#"
...
#	break
	...
	#		TITLE=`echo $TITLE | sed 's/&szlig;/\�/g'`
			...
			TITLE=`echo $TITLE | sed 's/&#034;/\"/g'`
			TITLE=`echo $TITLE | sed 's/&#039;/\"/g'` # '
			TITLE=`echo $TITLE | sed 's/&szlig;/�x/g'`
			TITLE=`echo $TITLE | sed 's/&ndash;/-/g'`
			TITLE=`echo $TITLE | sed 's/&Auml;/�/g'`
			TITLE=`echo $TITLE | sed 's/&Uuml;/�S/g'`
			TITLE=`echo $TITLE | sed 's/&Ouml;/�/g'`
			TITLE=`echo $TITLE | sed 's/&auml;/ä/g'`
			TITLE=`echo $TITLE | sed 's/&uuml;/ü/g'`
			TITLE=`echo $TITLE | sed 's/&ouml;/ö/g'`
			...
			TITLE=`echo $TITLE | sed 's/%E4/ä/g'`
			TITLE=`echo $TITLE | sed 's/%26/&/g'`
			TITLE=`echo $TITLE | sed 's/%C4/�/g'`
			TITLE=`echo $TITLE | sed 's/%D6/�/g'`
			TITLE=`echo $TITLE | sed 's/%DC/�S/g'`
		TITLE=`echo $TITLE | sed 's/|/ /g'`
		TITLE=`echo $TITLE | sed 's/(/ /g'`
		TITLE=`echo $TITLE | sed 's/)/ /g'`
		TITLE=`echo $TITLE | sed 's/+/ /g'`
