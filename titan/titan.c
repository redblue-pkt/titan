...
//#endif
	...
	if(checkbox("VUDUO4K") == 1 || checkbox("VUZERO4K") == 1  || checkbox("VUUNO4K") == 1  || checkbox("VUULTIMO4K") == 1)
	{
...
//#endif
	...
	if(checkbox("DM7020HD") == 0 && checkbox("DM7020HDV2") == 0 && checkbox("VUSOLO2") == 0 && checkbox("DM900") == 0 && checkbox("DM920") == 0 && checkbox("DM520") == 0 && checkbox("DM525") == 0 && vubox1 == 1)
		setfbosd();
	if(checkrealbox("HD51") == 1 || checkrealbox("HD60") == 1 || checkrealbox("HD61") == 1 || checkrealbox("SF8008") == 1 || checkrealbox("SF4008") == 1 || checkrealbox("SF8008S") == 1 || checkrealbox("SF8008T") == 1 || checkchipset("HI3798MV200") == 1)
	{
		setfbosdnull();
	}
