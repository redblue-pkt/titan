...
void updatevfd()
{
	...
	if(status.standby == 0 && checkbox("DM7020HD") != 1 && checkbox("DM7020HDV2") != 1 && checkbox("ATEMIO530") != 1 && checkbox("ATEMIO520") != 1 && checkbox("IPBOX91") != 1 && checkbox("ATEMIO6000") != 1 && checkbox("ATEMIO6100") != 1)
	{
...
void vfdrecordthread()
{
	...
	while(VFD_Recordthread->aktion != STOP && getconfigint("vfdisplayrecord", NULL) != 0 && status.recording > 0)
	{
		...
		{
			action = 2;
			if(checkchipset("BCM7358") == 1 || checkbox("ATEMIO6200") == 1 || checkchipset("BCM7424") == 1 || checkbox("DM7020HD") == 1 || checkbox("DM7020HDV2") == 1) //inihde inihdp
				writevfd("RECORD");
