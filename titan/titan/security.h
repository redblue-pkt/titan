...
//			{
				...
				debug(299, "1Community connecting: tpk upgrade");
				if(count == 1)
					tpkgetindex(0);
...
#else
				debug(199, "1Community connecting: ipkg upgrade");
				debug(299, "1Community connecting: ipkg upgrade");
				ipkg_update();
				freeipkg();
...
int vbulletin_userauth(char* link, char* user, char* pass)
{
	...
	debug(299, "vbulletin user: %s", user);
