...
//					if (checkbox("ATEMIO5000") != 1)
		...
		if(rcret == getrcconfigint("rcshoot", NULL))
		{
			...
			drawscreen(skin, 0, 0);
			subtitlepause(0);
			textbox(_("Message"), _("Screenshoot created on /tmp/screenshoot.png !"), _("OK"), getrcconfigint("rcok", NULL), _("EXIT"), getrcconfigint("rcexit", NULL), NULL, 0, NULL, 0, 600, 200, 10, 0);
			continue;
		}
