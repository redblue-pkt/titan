...
if [ "$GROUP" = "dev" ]; then
    mkdir .deps
    echo make1
    $SRC/tmp/sysroots/$ARCH/usr/bin/$GCCPATH/$GCCPATH-gcc -mhard-float --sysroot=$SRC/tmp/sysroots/$BOX -DPACKAGE_NAME=\"tuxbox-apps-titan\" -DPACKAGE_TARNAME=\"tuxbox-titan\" -DPACKAGE_VERSION=\"0.0.1\" -DPACKAGE_STRING=\"tuxbox-apps-titan\ 0.0.1\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"tuxbox-titan\" -DVERSION=\"0.0.1\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_DLFCN_H=1 -DLT_OBJDIR=\".libs/\" -I.    -DDVDPLAYER -DARM -DMIPSEL -D$DREAM -DCAMSUPP -D$eplayer -Os -mhard-float $devflag -export-dynamic -Wall -Wno-unused-but-set-variable -Wno-implicit-function-declaration -I$SRC/tmp/sysroots/$BOX/usr/include                                                                                                                    -I$eplayerinclude     -I$SRC/tmp/sysroots/$BOX/usr/include/glib-2.0   -I$SRC/tmp/sysroots/$BOX/usr/include/libxml2    -I$SRC/tmp/sysroots/$BOX/usr/lib/glib-2.0/include   -I$SRC/tmp/sysroots/$BOX/usr/include/freetype2  -I$SRC/tmp/sysroots/$BOX/usr/include/dreamdvd   -I$SRC/tmp/sysroots/$BOX/usr/include/libdreamdvd    -I$SRC/tmp/sysroots/$BOX/usr/include -I"$HOME"/flashimg/source.titan/libdreamdvd     -I$eplayerinclude 	-I"$HOME"/flashimg/source.titan/titan -MT titan-titan.o -DARM -DMIPSEL -D$DREAM -DCAMSUPP -D$eplayer -MD -MP -MF .deps/titan-titan.Tpo -c -o titan-titan.o `test -f 'titan.c' || echo './'`titan.c
#   $SRC/tmp/sysroots/$ARCH/usr/bin/$GCCPATH/$GCCPATH-gcc -mhard-float --sysroot=$SRC/tmp/sysroots/$BOX -DPACKAGE_NAME=\"tuxbox-apps-titan\" -DPACKAGE_TARNAME=\"tuxbox-titan\" -DPACKAGE_VERSION=\"0.0.1\" -DPACKAGE_STRING=\"tuxbox-apps-titan\ 0.0.1\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"tuxbox-titan\" -DVERSION=\"0.0.1\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_DLFCN_H=1 -DLT_OBJDIR=\".libs/\" -I.    -DDVDPLAYER -DARM -DMIPSEL -D$DREAM -DCAMSUPP -DEPLAYER4 -Os -mhard-float $devflag -export-dynamic -Wall -Wno-unused-but-set-variable -Wno-implicit-function-declaration -I$SRC/tmp/sysroots/$BOX/usr/include     -I$SRC/tmp/sysroots/$BOX/usr/include/$eplayerlib     -I$SRC/tmp/sysroots/$BOX/usr/lib/$eplayerlib/include                           -I$SRC/tmp/sysroots/$BOX/usr/include/glib-2.0   -I$SRC/tmp/sysroots/$BOX/usr/include/libxml2    -I$SRC/tmp/sysroots/$BOX/usr/lib/glib-2.0/include   -I$SRC/tmp/sysroots/$BOX/usr/include/freetype2  -I$SRC/tmp/sysroots/$BOX/usr/include/dreamdvd   -I$SRC/tmp/sysroots/$BOX/usr/include/libdreamdvd    -I$SRC/tmp/sysroots/$BOX/usr/include -I"$HOME"/flashimg/source.titan/libdreamdvd                          -I"$HOME"/flashimg/source.titan/titan -MT titan-titan.o -DARM -DMIPSEL -D$DREAM -DCAMSUPP -DEPLAYER4 -MD -MP -MF .deps/titan-titan.Tpo -c -o titan-titan.o `test -f 'titan.c' || echo './'`titan.c
    ...
    echo make2
    $SRC/tmp/sysroots/$BOX/usr/bin/crossscripts/$GCCPATH-libtool  --tag=CC   --mode=link $SRC/tmp/sysroots/$ARCH/usr/bin/$GCCPATH/$GCCPATH-gcc -mhard-float --sysroot=$SRC/tmp/sysroots/$BOX -DARM -DMIPSEL -D$DREAM -DCAMSUPP -D$eplayer -Os -mhard-float $devflag -export-dynamic -Wall -Wno-unused-but-set-variable -Wno-implicit-function-declaration -I$SRC/tmp/sysroots/$BOX/usr/include                                                                                                                 -I$eplayerinclude     -I$SRC/tmp/sysroots/$BOX/usr/include/glib-2.0   -I$SRC/tmp/sysroots/$BOX/usr/include/libxml2    -I$SRC/tmp/sysroots/$BOX/usr/lib/glib-2.0/include   -I$SRC/tmp/sysroots/$BOX/usr/include/freetype2  -I$SRC/tmp/sysroots/$BOX/usr/include/openssl  -I$SRC/tmp/sysroots/$BOX/usr/include/dreamdvd   -I$SRC/tmp/sysroots/$BOX/usr/include/libdreamdvd    -I"$HOME"/flashimg/source.titan/libdreamdvd     -I"$HOME"/flashimg/source.titan/titan -DARM -DMIPSEL -D$DREAM -DCAMSUPP -D$eplayer -Wl,-O1  -Wl,--as-needed -o titan titan-titan.o -DDVDPLAYER -DARM -DMIPSEL -D$DREAM -DCAMSUPP -lm -lglib-2.0 -lgobject-2.0 -lpthread -ldl -lz -lpng -lfreetype -l$eplayerlib -ldreamdvd -ljpeg -lssl -lcrypto
#   $SRC/tmp/sysroots/$BOX/usr/bin/crossscripts/$GCCPATH-libtool  --tag=CC   --mode=link $SRC/tmp/sysroots/$ARCH/usr/bin/$GCCPATH/$GCCPATH-gcc -mhard-float --sysroot=$SRC/tmp/sysroots/$BOX -DARM -DMIPSEL -D$DREAM -DCAMSUPP -DEPLAYER4 -Os -mhard-float $devflag -export-dynamic -Wall -Wno-unused-but-set-variable -Wno-implicit-function-declaration -I$SRC/tmp/sysroots/$BOX/usr/include   -I$SRC/tmp/sysroots/$BOX/usr/include/$eplayerlib     -I$SRC/tmp/sysroots/$BOX/usr/lib/$eplayerlib/include                           -I$SRC/tmp/sysroots/$BOX/usr/include/glib-2.0   -I$SRC/tmp/sysroots/$BOX/usr/include/libxml2    -I$SRC/tmp/sysroots/$BOX/usr/lib/glib-2.0/include   -I$SRC/tmp/sysroots/$BOX/usr/include/freetype2  -I$SRC/tmp/sysroots/$BOX/usr/include/openssl  -I$SRC/tmp/sysroots/$BOX/usr/include/dreamdvd   -I$SRC/tmp/sysroots/$BOX/usr/include/libdreamdvd    -I"$HOME"/flashimg/source.titan/libdreamdvd     -I"$HOME"/flashimg/source.titan/titan -DARM -DMIPSEL -D$DREAM -DCAMSUPP -DEPLAYER4 -Wl,-O1  -Wl,--as-needed -o titan titan-titan.o -DDVDPLAYER -DARM -DMIPSEL -D$DREAM -DCAMSUPP -lm -lglib-2.0 -lgobject-2.0 -lpthread -ldl -lz -lpng -lfreetype -l$eplayerlib -ldreamdvd -ljpeg -lssl -lcrypto
