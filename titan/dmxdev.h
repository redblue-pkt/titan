...
int dmxsetsource(struct dvbdev* node, int source)
{
	...
	if(checkrealbox("HD51") == 1 || checkrealbox("HD60") == 1 || checkrealbox("HD61") == 1 || checkchipset("HI3798MV200") == 1 || vubox1 == 1)  //source darf bei dieser Box nur einmal gesetzt werden, l\F6scht ansonsten die Filter.
	{
