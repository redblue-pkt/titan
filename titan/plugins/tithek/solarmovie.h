...
int solarmovie_hoster(struct skin* grid, struct skin* listbox, struct skin* countlabel, struct skin* load, char* link, char* title)
{
	...
	int ret = 1;
	char* ip = NULL, *pos = NULL, *path = NULL, *update = NULL, *quality = NULL, *id = NULL, *line = NULL, *hname = NULL, *tmpstr = NULL, *tmpstr2 = NULL, *tmpstr3 = NULL, *cmd = NULL, *url = NULL, *tmpstr1 = NULL, *tmpfile = NULL, *tmphost = NULL, *menu = NULL;
