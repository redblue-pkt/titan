...
char* changeweatherpic(char* icon)
{
	...
	if(icon == NULL)
		...
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/10.png", 0, 0);
	else if(ostrstr(icon, "11") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/11.png", 0, 0);
	else if(ostrstr(icon, "12") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/12.png", 0, 0);		
	else if(ostrstr(icon, "13") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/13.png", 0, 0);	
	else if(ostrstr(icon, "14") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/14.png", 0, 0);			
	else if(ostrstr(icon, "15") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/15.png", 0, 0);	
	else if(ostrstr(icon, "16") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/16.png", 0, 0);	
	else if(ostrstr(icon, "17") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/17.png", 0, 0);	
	else if(ostrstr(icon, "18") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/18.png", 0, 0);	
	else if(ostrstr(icon, "19") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/19.png", 0, 0);	
	else if(ostrstr(icon, "20") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/20.png", 0, 0);	
	else if(ostrstr(icon, "21") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/21.png", 0, 0);	
	else if(ostrstr(icon, "22") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/22.png", 0, 0);	
	else if(ostrstr(icon, "23") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/23.png", 0, 0);	
	else if(ostrstr(icon, "24") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/24.png", 0, 0);	
	else if(ostrstr(icon, "25") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/25.png", 0, 0);	
	else if(ostrstr(icon, "26") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/26.png", 0, 0);	
	else if(ostrstr(icon, "27") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/27.png", 0, 0);	
	else if(ostrstr(icon, "28") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/28.png", 0, 0);
	else if(ostrstr(icon, "29") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/29.png", 0, 0);	
	else if(ostrstr(icon, "30") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/30.png", 0, 0);	
	else if(ostrstr(icon, "31") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/31.png", 0, 0);	
	else if(ostrstr(icon, "32") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/32.png", 0, 0);	
	else if(ostrstr(icon, "33") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/33.png", 0, 0);	
	else if(ostrstr(icon, "34") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/34.png", 0, 0);			
	else if(ostrstr(icon, "35") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/35.png", 0, 0);	
	else if(ostrstr(icon, "36") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/36.png", 0, 0);	
	else if(ostrstr(icon, "37") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/37.png", 0, 0);	
	else if(ostrstr(icon, "38") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/38.png", 0, 0);	
	else if(ostrstr(icon, "39") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/39.png", 0, 0);			
	else if(ostrstr(icon, "40") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/40.png", 0, 0);	
	else if(ostrstr(icon, "41") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/41.png", 0, 0);	
	else if(ostrstr(icon, "42") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/42.png", 0, 0);			
	else if(ostrstr(icon, "43") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/43.png", 0, 0);	
	else if(ostrstr(icon, "44") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/44.png", 0, 0);	
	else if(ostrstr(icon, "45") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/45.png", 0, 0);	
	else if(ostrstr(icon, "46") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/46.png", 0, 0);	
	else if(ostrstr(icon, "47") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/47.png", 0, 0);
	else if(ostrstr(icon, "0") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/0.png", 0, 0);	
	else if(ostrstr(icon, "1") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/1.png", 0, 0);	
	else if(ostrstr(icon, "2") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/2.png", 0, 0);	
	else if(ostrstr(icon, "3") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/3.png", 0, 0);
	else if(ostrstr(icon, "4") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/4.png", 0, 0);	
	else if(ostrstr(icon, "5") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/5.png", 0, 0);	
	else if(ostrstr(icon, "6") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/6.png", 0, 0);	
	else if(ostrstr(icon, "7") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/7.png", 0, 0);	
	else if(ostrstr(icon, "8") != NULL)
		node = ostrcat(node, "%pluginpath%/lcdsamsung/skin/8.png", 0, 0);
