...
char* changeweatherpic(char* icon)
{
	...
	if(icon == NULL)
		...
		node = ostrcat(node, "%pluginpath%/samsung/skin/sunny60.png", 0, 0);
	else if(ostrstr(icon, "/mostly_sunny.gif") != NULL)
		node = ostrcat(node, "%pluginpath%/samsung/skin/mostly_sunny60.png", 0, 0);
  else if(ostrstr(icon, "/chance_of_rain.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/chance_of_rain60.png", 0, 0);
  else if(ostrstr(icon, "/partly_cloudy.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/partly_cloudy60.png", 0, 0);
  else if(ostrstr(icon, "/mostly_cloudy.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/mostly_cloudy60.png", 0, 0);
  else if(ostrstr(icon, "/chance_of_storm.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/chance_of_storm60.png", 0, 0);
	else if(ostrstr(icon, "/showers.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/showers60.png", 0, 0);
  else if(ostrstr(icon, "/rain.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/rain60.png", 0, 0);
  else if(ostrstr(icon, "/chance_of_snow.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/chance_of_snow60.png", 0, 0);
  else if(ostrstr(icon, "/cloudy.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/cloudy60.png", 0, 0);
  else if(ostrstr(icon, "/storm.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/storm60.png", 0, 0);
  else if(ostrstr(icon, "/thunderstorm.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/storm60.png", 0, 0);
  else if(ostrstr(icon, "/chance_of_tstorm.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/chance_of_storm.png", 0, 0);
  else if(ostrstr(icon, "/sleet.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/snow60.png", 0, 0);
  else if(ostrstr(icon, "/snow.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/snow60.png", 0, 0);
  else if(ostrstr(icon, "/icy.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/icy60.png", 0, 0);
  else if(ostrstr(icon, "/dust.gif") != NULL)
  	node = ostrcat(node, "%pluginpath%/samsung/skin/fog60.png", 0, 0);
  	...
  	node = ostrcat(node, "%pluginpath%/samsung/skin/flurries60.png", 0, 0);
  return node;	
}
