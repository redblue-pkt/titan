...
void init(void)
{
	...
	tmpstr = ostrcat("/var/usr/local/share/titan/plugins/wlandisplay/skin2.xml", NULL, 0, 0);
	if(!file_exist(tmpstr))
	{
		free(tmpstr); tmpstr = NULL;
		tmpstr = ostrcat("/var/swap/usr/local/share/titan/plugins/wlandisplay/skin2.xml", NULL, 0, 0);
	}
	if(!file_exist(tmpstr))
	{
		free(tmpstr); tmpstr = NULL;
		tmpstr = ostrcat("/mnt/swapextensions/usr/local/share/titan/plugins/wlandisplay/skin2.xml", NULL, 0, 0);
	}
	if(!file_exist(tmpstr))
	{
		free(tmpstr); tmpstr = NULL;
