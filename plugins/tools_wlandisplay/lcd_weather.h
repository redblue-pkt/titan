...
char* changeweatherpic(char* icon)
{
	...
	if(icon == NULL)
		...
		node = createpluginpath("/wlandisplay/skin/10.png", 0);
	else if(ostrstr(icon, "11") != NULL)
		node = createpluginpath("/wlandisplay/skin/11.png", 0);
	else if(ostrstr(icon, "12") != NULL)
		node = createpluginpath("/wlandisplay/skin/12.png", 0);		
	else if(ostrstr(icon, "13") != NULL)
		node = createpluginpath("/wlandisplay/skin/13.png", 0);	
	else if(ostrstr(icon, "14") != NULL)
		node = createpluginpath("/wlandisplay/skin/14.png", 0);			
	else if(ostrstr(icon, "15") != NULL)
		node = createpluginpath("/wlandisplay/skin/15.png", 0);	
	else if(ostrstr(icon, "16") != NULL)
		node = createpluginpath("/wlandisplay/skin/16.png", 0);	
	else if(ostrstr(icon, "17") != NULL)
		node = createpluginpath("/wlandisplay/skin/17.png", 0);	
	else if(ostrstr(icon, "18") != NULL)
		node = createpluginpath("/wlandisplay/skin/18.png", 0);	
	else if(ostrstr(icon, "19") != NULL)
		node = createpluginpath("/wlandisplay/skin/19.png", 0);	
	else if(ostrstr(icon, "20") != NULL)
		node = createpluginpath("/wlandisplay/skin/20.png", 0);	
	else if(ostrstr(icon, "21") != NULL)
		node = createpluginpath("/wlandisplay/skin/21.png", 0);	
	else if(ostrstr(icon, "22") != NULL)
		node = createpluginpath("/wlandisplay/skin/22.png", 0);	
	else if(ostrstr(icon, "23") != NULL)
		node = createpluginpath("/wlandisplay/skin/23.png", 0);	
	else if(ostrstr(icon, "24") != NULL)
		node = createpluginpath("/wlandisplay/skin/24.png", 0);	
	else if(ostrstr(icon, "25") != NULL)
		node = createpluginpath("/wlandisplay/skin/25.png", 0);	
	else if(ostrstr(icon, "26") != NULL)
		node = createpluginpath("/wlandisplay/skin/26.png", 0);	
	else if(ostrstr(icon, "27") != NULL)
		node = createpluginpath("/wlandisplay/skin/27.png", 0);	
	else if(ostrstr(icon, "28") != NULL)
		node = createpluginpath("/wlandisplay/skin/28.png", 0);
	else if(ostrstr(icon, "29") != NULL)
		node = createpluginpath("/wlandisplay/skin/29.png", 0);	
	else if(ostrstr(icon, "30") != NULL)
		node = createpluginpath("/wlandisplay/skin/30.png", 0);	
	else if(ostrstr(icon, "31") != NULL)
		node = createpluginpath("/wlandisplay/skin/31.png", 0);	
	else if(ostrstr(icon, "32") != NULL)
		node = createpluginpath("/wlandisplay/skin/32.png", 0);	
	else if(ostrstr(icon, "33") != NULL)
		node = createpluginpath("/wlandisplay/skin/33.png", 0);	
	else if(ostrstr(icon, "34") != NULL)
		node = createpluginpath("/wlandisplay/skin/34.png", 0);			
	else if(ostrstr(icon, "35") != NULL)
		node = createpluginpath("/wlandisplay/skin/35.png", 0);	
	else if(ostrstr(icon, "36") != NULL)
		node = createpluginpath("/wlandisplay/skin/36.png", 0);	
	else if(ostrstr(icon, "37") != NULL)
		node = createpluginpath("/wlandisplay/skin/37.png", 0);	
	else if(ostrstr(icon, "38") != NULL)
		node = createpluginpath("/wlandisplay/skin/38.png", 0);	
	else if(ostrstr(icon, "39") != NULL)
		node = createpluginpath("/wlandisplay/skin/39.png", 0);			
	else if(ostrstr(icon, "40") != NULL)
		node = createpluginpath("/wlandisplay/skin/40.png", 0);	
	else if(ostrstr(icon, "41") != NULL)
		node = createpluginpath("/wlandisplay/skin/41.png", 0);	
	else if(ostrstr(icon, "42") != NULL)
		node = createpluginpath("/wlandisplay/skin/42.png", 0);			
	else if(ostrstr(icon, "43") != NULL)
		node = createpluginpath("/wlandisplay/skin/43.png", 0);	
	else if(ostrstr(icon, "44") != NULL)
		node = createpluginpath("/wlandisplay/skin/44.png", 0);	
	else if(ostrstr(icon, "45") != NULL)
		node = createpluginpath("/wlandisplay/skin/45.png", 0);	
	else if(ostrstr(icon, "46") != NULL)
		node = createpluginpath("/wlandisplay/skin/46.png", 0);	
	else if(ostrstr(icon, "47") != NULL)
		node = createpluginpath("/wlandisplay/skin/47.png", 0);
	else if(ostrstr(icon, "0") != NULL)
		node = createpluginpath("/wlandisplay/skin/0.png", 0);	
	else if(ostrstr(icon, "1") != NULL)
		node = createpluginpath("/wlandisplay/skin/1.png", 0);	
	else if(ostrstr(icon, "2") != NULL)
		node = createpluginpath("/wlandisplay/skin/2.png", 0);	
	else if(ostrstr(icon, "3") != NULL)
		node = createpluginpath("/wlandisplay/skin/3.png", 0);
	else if(ostrstr(icon, "4") != NULL)
		node = createpluginpath("/wlandisplay/skin/4.png", 0);	
	else if(ostrstr(icon, "5") != NULL)
		node = createpluginpath("/wlandisplay/skin/5.png", 0);	
	else if(ostrstr(icon, "6") != NULL)
		node = createpluginpath("/wlandisplay/skin/6.png", 0);	
	else if(ostrstr(icon, "7") != NULL)
		node = createpluginpath("/wlandisplay/skin/7.png", 0);	
	else if(ostrstr(icon, "8") != NULL)
		node = createpluginpath("/wlandisplay/skin/8.png", 0);
	else if(ostrstr(icon, "9") != NULL)
		node = createpluginpath("/wlandisplay/skin/9.png", 0);		
	else
		node = createpluginpath("/wlandisplay/skin/na.png", 0);
...
void lcd_writeweather()
{
	...
	location = ostrcat(location, getconfig("lcd_wlan_plugin_wetterort", NULL), 0, 0);
