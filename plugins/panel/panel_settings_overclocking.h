...
{
	if(checkbox("UFS912") || checkbox("ATEMIO520") || checkbox("SPARK") || checkbox("ATEMIO510") || checkbox("ATEMIO7600") || checkbox("WHITEBOX"))
		return;
...
void screenpanel_settings_overclocking()
{
	...
	if(checkbox("UFS912") == 0 && checkbox("ATEMIO520") == 0 && checkbox("SPARK") == 0 && checkbox("ATEMIO510") == 0 && checkbox("ATEMIO7600") == 0 && checkbox("WHITEBOX") == 0)
	{
		node = addlistbox(panel_overclock, listbox, node, 1);
		if(node != NULL)
		{
